      ...
      <div className="flex flex-col gap-6 p-2">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <BarLineChart
            ...
            footerText="Crescimento de 7,8% em relação ao ano passado"
            footerSubtext="A exibir a distribuição de matrículas por curso nos últimos 12 meses"
            growthText="Crescimento de 7,8% em relação ao ano passado"
          />
          {/* PieChartC */}
          <PieChartC
            data={reportsByDepartment}
            config={reportsConfig}
            title="Relatórios por Turno"
            description="Distribuição de matrículas por turno neste semestre"
            centerLabel={{
        ...
        <div className="grid grid-cols-3 gap-4">
          <BarVchart
            ...
            footerText="Total de matrículas por estado"
            activeIndex={2}
          />
          {/* To Do List */}
