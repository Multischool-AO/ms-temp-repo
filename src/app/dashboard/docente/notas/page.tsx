...
import TableTurmas from "@/components/dashboard/docentes/tableTurmas";

export default async function Departamentos() {
   const departmentData = {
     title: "Gestão de Notas",
     description: "Gestão e lançamento de notas",
     imageUrl: "/tests.jpeg",
     iconUrl:
     ...
     summary: [
       {
         icon: "",
         label: "Instituto Superior Politécnico de Ciências e Tecnologias",
       },
     ],
