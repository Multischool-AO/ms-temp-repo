...
const columns = [
  { name: "#", uid: "id" },
  { name: "Nº DE MATRÍCULA", uid: "userId" },
  { name: "VALOR", uid: "total", sortable: true },
  { name: "DATA", uid: "orderDate", sortable: true },
...
export default function OrdersTable({ orders }: { orders?: OrderProps[] }) {
  ...
  const filteredItems = React.useMemo(() => {
    // Provide a default value of an empty array if orders is undefined
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-small text-default-400">
            Total de pagamentos: {orders?.length || 0}
          </span>
  ...
  return (
    ...
    >
      ...
      <TableBody
        emptyContent={"Não existem pagamentos disponíveis"}
        items={sortedItems || []}
      >
        {(item) => (
