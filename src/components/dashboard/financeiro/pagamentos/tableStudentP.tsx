...
import { estsP } from "@/constants/academic";
...
type User = (typeof estsP)[0];

export default function TableStudentP() {
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (
      ...
      filteredUsers = filteredUsers.filter((est) =>
        Array.from(statusFilter).includes(est.ent)
      );
    }

    return filteredUsers;
  }, [estsP, filterValue, statusFilter]);
            ...
            <div className="relative flex items-center gap-2 text-center">
              <Tooltip content="Visualizar">
                <span
                  ...
                  onClick={() => router.push(`pagamentos/${est.nmatr}`)}
                >
                  <EyeIcon />
                </span>
              </Tooltip>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            {estsP.length} Estudantes no total
          </span>
