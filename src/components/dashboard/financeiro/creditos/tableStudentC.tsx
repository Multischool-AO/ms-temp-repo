...
import { estsC } from "@/constants/academic";
...
type User = (typeof estsC)[0];

export default function TableStudentC() {
  ...
  }, [estsC, filterValue, statusFilter]);
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            {estsC.length} Estudantes no total
          </span>
