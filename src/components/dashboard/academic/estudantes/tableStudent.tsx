...
export const columns = [
  ...
  { name: "ANO", uid: "ano", sortable: true },
  { name: "TURMA", uid: "trm", sortable: true },
  { name: "SALA", uid: "sala", sortable: true },
            ...
            <div className="relative flex items-center gap-2 text-center">
              <Tooltip content="Visualizar">
                <span
                  ...
                  onClick={() => router.push(`estudantes/${est.nmatr}`)}
                >
                  <EyeIcon />
                </span>
              </Tooltip>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            {ests.length} Estudantes no total
          </span>
