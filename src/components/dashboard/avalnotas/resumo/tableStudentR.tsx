...
import { estsN } from "@/constants/academic";
...
export const columns = [
  ...
  { name: "CADEIRA", uid: "cad" },
  { name: "MÉDIA", uid: "mfinal", sortable: true },
...
export const statusOptions = [
  ...
  { name: "Reprovado", uid: "Reprovado" },
  { name: "Recurso", uid: "Recurso" },
  { name: "Especial", uid: "Especial" },
];
...
type User = (typeof estsN)[0];

export default function TableStudentR() {
  ...
  }, [estsN, filterValue, statusFilter]);
  ...
  const renderCell = React.useCallback((est: User, columnKey: React.Key) => {
    ...
    switch (columnKey) {
      ...
      case "mfinal":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{cellValue}v</p>
          </div>
        );
      case "status":
        return (
            ...
            <div className="relative flex items-center gap-2 text-center">
              <Tooltip content="Visualizar">
                <span
                  ...
                  onClick={() => router.push(`resumo/${est.nmatr}`)}
                >
                  <EyeIcon />
                </span>
              </Tooltip>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            {estsN.length} Estudantes no total
          </span>
