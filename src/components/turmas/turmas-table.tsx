...
const columns = [
  { name: "#", uid: "id" },
  { name: "NOME", uid: "nome" },
  { name: "NOME CURTO", uid: "shortName" },
  { name: "PREÇO", uid: "basePrice", sortable: true },
  { name: "FACULDADE", uid: "facul", sortable: true },
  { name: "ESTADO", uid: "stock", sortable: true },
  { name: "INSCRITOS", uid: "totalI", sortable: true },
...
export default function TurmasTable() {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-small text-default-400">
            Total de cursos: {data?.products.length}
          </span>
  ...
  return (
    ...
    >
      ...
      <TableBody
        emptyContent={"Não foram encontradas turmas"}
        items={sortedItems || []}
      >
        {(item) => (
